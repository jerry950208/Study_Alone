...
// 이 문제는 반복문이 아닌 메서드로 배열의 요소 값을 출력하는 방법에 대해서 아는지를 묻는 문제이다


// [!] : Arrays.toString() 메서드
// 반복문을 사용하지 않고 배열의 값을 출력하고자 한다면 Arrays 클래스의 toString() 메서드를 사용하면 된다
// toString()의 인자로는 배열명을 넣어주면 된다
// 사용을 위해서는 기본적으로 java.util.Arrays 임포드 선언이 되어져 있어야 한다 --> 이때도 세미콜론(;) 까먹지 않도록 주의
...
public class Array_Basic_007{
	...
	public static void main(String[] args){
		...
		//[1] : 배열 선언
		int arr[] = {238, 483, 239, 442, 287, 239, 873};

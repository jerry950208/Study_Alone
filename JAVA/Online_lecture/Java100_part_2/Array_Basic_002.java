// 배열과 인덱스의 관계에 대해서 설명하고 배열의 초깃값은 어떻게 셋팅되는지 알아보시오
...
// 주소 값은 다른 표현으로 참조 값이라고도 부른다
// 공간이 10개가 만들어지면 동시에 자동적으로 해당공간에 접근할 수 있는 인덱스 번호가 자동 부여된다 --> 인덱스 번호는 0부터 시작
...
public class Array_Basic_002{
	...
	public static void main(String[] args){
		...
		int s_size = scores.length;		// 배열의 크기 저장
		...
		System.out.println(scores[s_size-1]);	// scores[9] idx
